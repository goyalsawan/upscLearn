...
/// Swipeable card deck experience for a lesson.
class LessonCardView extends StatefulWidget {
  final Lesson lesson;
  ...
  @override
  State<LessonCardView> createState() => _LessonCardViewState();
}

class _LessonCardViewState extends State<LessonCardView>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // ── Page Indicator ──────────────────────────────────────
          _buildPageIndicator(theme, isDark, total),
    ...
    return AppBar(
      ...
      title: Column(
        children: [
          ...
          Text(
            '${widget.lesson.readingTimeMinutes} min lesson  •  $total cards',
            style: TextStyle(
              fontSize: 11,
  ...
  Widget _buildPageIndicator(ThemeData theme, bool isDark, int total) {
    return Padding(
      ...
      child: Center(
        child: SmoothPageIndicator(
          ...
          effect: ExpandingDotsEffect(
            dotHeight: 5,
            dotWidth: 8,
            activeDotColor: isDark ? Colors.amber : theme.primaryColor,
            dotColor: isDark ? const Color(0xFF1E293B) : Colors.grey.shade200,
            expansionFactor: 4,
            spacing: 6,
          ),
        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (card.tip != null) ...[
                                ...
                                _buildTipBox(card.tip!, theme, isDark, cardColors.$1),
                              ],
                            ],
                          ),
                        ),
  ...
  Widget _buildTipBox(
      String tip, ThemeData theme, bool isDark, Color accentColor) {
    return Container(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            // Center completion or next button
            Expanded(
              child: isLast
                  ? GestureDetector(
                      onTap: () {
  ...
  /// Gradient colors for each card slot.
  (Color, Color) _cardColorPair(int index, bool isDark) {
    final palettes = isDark
        ? [
            ...
            (const Color(0xFF991B1B), const Color(0xFFDC2626)), // Red
        ...
        : [
            ...
            (const Color(0xFFB91C1C), const Color(0xFFEF4444)), // Red
